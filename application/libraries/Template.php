...
class Template {
    ...
    function set_master_template($filename) {
        if (file_exists(APPPATH . 'views/' . $filename) or file_exists(APPPATH . 'views/' . $filename . ".php" )) {
            ...
            show_error('The filename provided does not exist in <strong>' . APPPATH . 'views</strong>. Remember to include the ".php" ension if other than ".php"');
        }
    }
    ...
    function initialize($props) {
        ...
        if (isset($props['template'])
            ...
            show_error('Either you have not provided a master template or the one provided does not exist in <strong>' . APPPATH . 'views</strong>. Remember to include the ".php" ension if other than ".php"');
        }
